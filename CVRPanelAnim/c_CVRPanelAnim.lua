...
addEventHandler("onClientResourceStart", resourceRoot, panelanimaciones,false)
...
function mpbailes(player)
	...
	if (guiGetVisible (Panelanim ) == true) and (not getPedOccupiedVehicle(player)) then
		guiSetVisible (Pbailes, true)
		guiSetVisible (Pbar,false)
		guiSetVisible (Pcrack,false)
		guiSetVisible (Pgym,false)
		guiSetVisible (Psenales,false)
...
function panelanim()
	...
	if not getPedOccupiedVehicle ( player ) then
		...
		if (guiGetVisible (Panelanim ) == false) then
			guiSetVisible (Panelanim , true)
			-- Se muestra el cursor
			showCursor(true)
		-- en caso de que el panel se esta mostrando se oculta
		else
		...
		outputChatBox ("No puedes usar animaciones dentro de vehículos")
	end
end

--addCommandHandler("Panim",panelanim)
bindKey("k", "down", panelanim)
--addCommandHandler("pararanima",pararanim)
----------------------------------------------------------------------------------------------
function pararanim ()
