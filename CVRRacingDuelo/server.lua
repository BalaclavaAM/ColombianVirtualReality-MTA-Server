...
addEventHandler('onRaceRoundStarting',root,
    function(plr1,plr2)
        ...
        if g_raceSpawn[plr1] and g_raceSpawn[plr2] then
            ...
            g_raceCars[plr1]=createVehicle(562,s1.x,s1.y,s1.z,0,0,180)
            g_raceCars[plr2]=createVehicle(562,s2.x,s2.y,s2.z,0,0,180)
            setElementDimension(g_raceCars[plr1],20)
            setElementDimension(g_raceCars[plr2],20)
            setElementDimension(plr1,20)
            setElementDimension(plr2,20)
