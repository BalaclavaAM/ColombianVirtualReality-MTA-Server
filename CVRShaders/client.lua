...
--[[
	...
	},
	{
		["id"] = "intensity",
		["interval"] = {0,1},
		["text"] = "Intensidad de color / Saturación",
		["percent"] = 0.0,
	},
	{
		["id"] = "color.a",
...
function renderFunc()
	...
	dxDrawText("Aplicar",posx,posy,posx+w,posy+25,nil,nil,"default-bold","center","center",nil,nil,true)
end
...
addCommandHandler("shader",function()
	...
	if (getElementData(localPlayer,"VIP") == "None" or getElementData(localPlayer,"VIP") == "Bronze" or getElementData(localPlayer,"VIP") == "Silver" or getElementData(localPlayer,"VIP") == "Gold") then 
		return outputChatBox("Debes ser vip Diamond o más para usar /shader") 
	end
