                ...
                if (distanceToVehicle < minDistance) and (getDoor(lookAtVehicle)) then
                    if (not isVehicleLocked(lookAtVehicle)) then
                        ...
                        elseif (getDoor(lookAtVehicle) == 2) then
                            doorName = "puerta delantera izquierda"
                        elseif (getDoor(lookAtVehicle) == 3) then
                            doorName = "puerta delantera derecha"
                        elseif (getDoor(lookAtVehicle) == 4) then
                            doorName = "puerta trasera izquierda"
                        elseif (getDoor(lookAtVehicle) == 5) then
                            doorName = "puerta trasera derecha"
                        end
                        ...
                        if (checkDoor ~= 4 ) then
                            ...
                            if (doorRatio <= 0) then
                                dxDrawText("#FFFFFFPresione #00FF00" .. interactButton .. "#FFFFFF para abrir #00FF00" .. doorName .. "#FFFFFF!", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2, tocolor(255, 255, 255, 255), 1, "arial", "center", "center", false, false, false, true, true)
                            else
                                dxDrawText("#FFFFFFPresione #00FF00" .. interactButton .. "#FFFFFF para cerrar #00FF00" .. doorName .. "#FFFFFF!", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2, tocolor(255, 255, 255, 255), 1, "arial", "center", "center", false, false, false, true, true)
                            end 
                        end
                    else
                        dxDrawRectangle ( screenWidth/2 - 100, screenHeight/2 - 8, 200, 16, tocolor( 0, 0, 0, 90 ))
                        dxDrawText("#FF0000 Vehiculo bloqueado!", screenWidth/2, screenHeight/2, screenWidth/2, screenHeight/2, tocolor(255, 255, 255, 255), 1, "arial", "center", "center", false, false, false, true, true)
                    end           
                end
            end
        end
