...
function drawing()
	if tostring(state) == "true" then
		...
		--#####Info do veiculo
			...
			dxDrawText(math.floor(speed).." l"..marcha, ivX, ivY, ivSX, ivSY, tocolor(255, 255, 255, 255), speedfontsize, speedfontdx, "right", "center", false, false, false, true, true) 
		...
		--#####Retangulo Grande Horizontal Brancos
			...
			rb1X, rb1Y, rb1SX, rb1SY = aToR( 1111, 519+SAFEZONE_Y+190, (tonumber(rpm)*3/182), 4) --rb
			dxDrawRectangle(rb1X, rb1Y, rb1SX, rb1SY,tocolor(255,255,255,255),false)
	--(rpm*3/182)
			rb1X, rb1Y, rb1SX, rb1SY = aToR( 1075+(tonumber(rpm)*3/182), 491+190+SAFEZONE_Y,65 , 60) --rb	
			--[[rpm brilho]]dxDrawImage ( rb1X, rb1Y, rb1SX, rb1SY,"fx/br.png", 0, 0, 0, tocolor(255,255,255,255))
			--[[rpm brilho]]dxDrawImage ( rb1X, rb1Y, rb1SX, rb1SY,"fx/br.png", 0, 0, 0, tocolor(255,255,255,255))		
		--#####Efeitos Retangulos Brancos

		if rpm > 407.407*1 then --[[01]]  alphafx1=255 else alphafx1 = 50 end
		if rpm > 407.407*2 then	--[[03]]  alphafx2=255 else alphafx2 = 50 end
		if rpm > 407.407*3  then	--[[04]]  alphafx3=255 else alphafx3 = 50 end
		if rpm > 407.407*4  then	--[[05]]  alphafx4=255 else alphafx4 = 50 end
		if rpm > 407.407*5  then	--[[06]] alphafx5=255 else alphafx5 = 50 end
		if rpm > 407.407*6  then	--[[07]]  alphafx6=255 else alphafx6 = 50 end
		if rpm > 407.407*7  then	--[[08]]  alphafx7=255 else alphafx7 = 50 end
		if rpm > 407.407*8  then	--[[09]]  alphafx8=255 else alphafx8 = 50 end
		if rpm > 407.407*9  then	--[[10]]  alphafx9=255 else alphafx9 = 50 end
		if rpm > 407.407*10  then	--[[11]]  alphafx10=255 else alphafx10 = 50 end
		if rpm > 407.407*11  then	--[[12]]  alphafx11=255 else alphafx11 = 50 end
		if rpm > 407.407*12  then	--[[13]]  alphafx12=255 else alphafx12 = 50 end
		if rpm > 407.407*13  then	--[[14]]  alphafx13=255 else alphafx13 = 50 end
		if rpm > 407.407*14  then	--[[15]] alphafx14=255 else alphafx14 = 50 end
		if rpm > 407.407*15  then	--[[16]]  alphafx15=255 else alphafx15 = 50 end
		if rpm > 407.407*16  then	--[[17]]  alphafx16=255 else alphafx16 = 50 end
		if rpm > 407.407*17  then	--[[18]]  alphafx17=255 else alphafx17 = 50 end
		if rpm > 407.407*18  then	--[[19]]  alphafx18=255 else alphafx18 = 50 end
		if rpm > 407.407*19  then	--[[20]]  alphafx19=255 else alphafx19 = 50 end
		if rpm > 407.407*20  then	--[[21]]  alphafx20=255 else alphafx20 = 50 end
		if rpm > 407.407*21 then	--[[22]]  alphafx21=255 else alphafx21 = 50 end
		if rpm > 407.407*22 then	--[[22]]  alphafx22=255 else alphafx22 = 50 end	
		if rpm > 407.407*23 then	--[[22]]  alphafx23=255 else alphafx23 = 50 end	
		if rpm > 407.407*24	then	--[[22]]  alphafx24=255 else alphafx24 = 50 end	
		if rpm > 407.407*25 then	--[[22]]  alphafx25=255 else alphafx25 = 50 end	
		if rpm > 407.407*26 then	--[[22]]  alphafx26=255 else alphafx26 = 50 end	
		if rpm > 407.407*27 then	--[[22]]  alphafx27=255 else alphafx27 = 50 end		
