...
function createBag()
	...
	outputChatBox("* #0069c7Un maletin de droga ha aparecido, llevalo a su destino (Icono malteada)",root,0,255,0,true)
end
	...
	function (player)
		if ( source == marker ) then
			if getElementType(player) == "player" then
				...
				destroyElement(bli)
				destroyElement(atBag)
				outputChatBox("* #ffffff[ #ff0000" .. getPlayerName(player) .. " #ffffff] #0069c7Ha ganado #00ff004000$ #0069c7al entregar el maletin de droga",root,255,0,0,true)
