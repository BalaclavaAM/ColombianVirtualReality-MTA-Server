...
function Panel()
	...
	Text("Beta ver. 2.0.2", 1080, 78, 1258, 107, tocolor(234, 234, 234, 255), 1.30, "default", "right", "top", false, false, true, false, false)
end
...
browserSwitch = "Skip Ads"
myBrowserURL = "https://www.youtube.com/"
switchedBrowser = false
function switchMyBrowser()
	if not isPanelVisible then return end
	Rectangle(755, 260, 67, 38, tocolor(34, 34, 34, 210), true)
	Text(browserSwitch, 751, 260, 828, 298, tocolor(255, 255, 255, 255), 1.25, "default", "center", "center", false, true, true, false, false)
end
...
HelpLabel = Label(2, 5, 746, 1100, [[G&T & Loki's Cinema Experience - Beta ver. 2.0.2
