    ...
    function()
        ...
        for i, p in ipairs(players) do
            ...
            if isGuestAccount(sourceAccount) then
                ...
                if
                    not (getAccountData(sourceAccount, "Weed")) and not (getAccountData(sourceAccount, "God")) and
                        not (getAccountData(sourceAccount, "Speed")) and
                        not (getAccountData(sourceAccount, "Lsd")) and
                        not (getAccountData(sourceAccount, "Steroids")) and
                        not (getAccountData(sourceAccount, "Heroin"))
                 then
                    setElementData(p, "Weed", 0)
                    setElementData(p, "God", 0)
                    setElementData(p, "Speed", 0)
...
addEventHandler(
    ...
    function()
		...
		triggerClientEvent(source, "onClientUseDrug", source)
    end
)
...
addEventHandler(
    ...
    function()
        ...
        setAccountData(acc, "God", getElementData(source, "God"))
       -- outputChatBox("You use God", source, 0, 255, 0, false)
        setPedAnimation(source, "BAR", "dnk_stndM_loop")
        setTimer(setPedAnimation, 3000, 1, source, nil, nil)
...
addEventHandler(
    ...
    function()
        ...
        setAccountData(acc, "Speed", getElementData(source, "Speed"))
        --outputChatBox("You use Speed", source, 0, 255, 0, false)
        setPedAnimation(source, "BAR", "dnk_stndM_loop")
        setTimer(setPedAnimation, 3000, 1, source, nil, nil)
		triggerClientEvent(source, "onClientUseDrug", source)
    end
...
addEventHandler(
    ...
    function()
        ...
        setAccountData(acc, "Lsd", getElementData(source, "Lsd"))
        --outputChatBox("You use Lsd", source, 0, 255, 0, false)
        setPedAnimation(source, "BAR", "dnk_stndM_loop")
        setTimer(setPedAnimation, 3000, 1, source, nil, nil)
		triggerClientEvent(source, "onClientUseDrug", source)
    end
...
addEventHandler(
    ...
    function()
        ...
        setAccountData(acc, "Steroids", getElementData(source, "Steroids"))
        --outputChatBox("You use Steroids", source, 0, 255, 0, false)
        setPedAnimation(source, "BAR", "dnk_stndM_loop")
        setTimer(setPedAnimation, 3000, 1, source, nil, nil)
...
addEventHandler(
    ...
    function()
        ...
        setAccountData(acc, "Heroin", getElementData(source, "Heroin"))
        --outputChatBox("You use Heroin", source, 0, 255, 0, false)
...
addEventHandler(
    ...
    root,
    function()
        if isElement(sigarSteroids) then
