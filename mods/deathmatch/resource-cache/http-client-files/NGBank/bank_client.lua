...
-- LS-Busetero
exports.ngwarpmanager:makeWarp ( { pos = { 1833.5, -1842.58, 14.5 }, toPos = { 832.67, 7.26, 1004.5 }, cInt = 0, cDim = 0, tInt = 3, tDim = 1 } )
exports.ngwarpmanager:makeWarp ( { pos = { 834.21, 7.45, 1004.5 }, toPos = { 1833.5, -1842.58, 14.5 }, cInt = 3, cDim = 1, tInt = 0, tDim = 0 } )
--LV
...
-- SF-Hospital
exports.ngwarpmanager:makeWarp ( { pos = { -2703.94, 639.37, 15.65 }, toPos = { 832.67, 7.26, 1004.5 }, cInt = 0, cDim = 0, tInt = 3, tDim = 2 } )
exports.ngwarpmanager:makeWarp ( { pos = { 834.21, 7.45, 1004.5 }, toPos = { -2703.94, 639.37, 14.45 }, cInt = 3, cDim = 2, tInt = 0, tDim = 0 } )
