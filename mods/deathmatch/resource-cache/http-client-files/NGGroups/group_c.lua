...
function createGroupGui ( )
	...
	gui.main.admin.visible = ( getElementData ( localPlayer, "staffLevel" ) or 0 ) > 4
	...
	gui.info.gMotd = guiCreateButton ( 318, 280, 130, 40, "Group MOTD", false, gui.main.window )  
		...
		-- info -> my invites
		gui.info.invites.window = guiCreateWindow(sx*345, sy*146, sx*640, sy*378, "My group invites", false)
		guiWindowSetSizable(gui.info.invites.window, false)
		gui.info.invites.label = guiCreateLabel(sx*38, sy*33, sx*504, sy*21, "My group invites", false, gui.info.invites.window)
		gui.info.invites.list = guiCreateGridList(sx*21, sy*54, sx*599, sy*267, false, gui.info.invites.window)
		...
		gui.info.invites.accept = guiCreateButton(sx*21, sy*331, sx*117, sy*31, "Accept", false, gui.info.invites.window)
		gui.info.invites.deny = guiCreateButton(sx*140, sy*331, sx*117, sy*31, "Deny", false, gui.info.invites.window)
		gui.info.invites.close = guiCreateButton(sx*503, sy*331, sx*117, sy*31, "Close", false, gui.info.invites.window )
		-- info -> motd
...
addCommandHandler("gang", onPlayerOpenPanel )
