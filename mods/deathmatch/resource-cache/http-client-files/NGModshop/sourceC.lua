							...
							if hasPlayerMoney(loopTable[hoveredCategory]["tuningPrice"]) then
								...
								if tuningName ~= "nitro" then
									...
									if loopTable[hoveredCategory]["tuningData"] == 0 then
										...
										if loopTable[hoveredCategory]["tuningData"] <= 50 then 
											triggerServerEvent("tuning->OpticalUpgrade", localPlayer, enteredVehicle, "add", 1008)
										elseif loopTable[hoveredCategory]["tuningData"] == 75 then
											triggerServerEvent("tuning->OpticalUpgrade", localPlayer, enteredVehicle, "add", 1009)
										elseif  loopTable[hoveredCategory]["tuningData"] == 100 then
...
function moneyChange(amount)
	...
	triggerServerEvent("takeServerMoney",getLocalPlayer(),amount) 
