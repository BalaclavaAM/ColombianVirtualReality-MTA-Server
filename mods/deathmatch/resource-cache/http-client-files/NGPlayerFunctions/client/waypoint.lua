...
function createWaypointLoc ( x, y, z )
	...
	if ( dist <= 20 ) then
		exports.NGMessages:sendClientMessage ( "Tu estas a solo "..tostring(math.floor(dist)).." metros de esta localizacion.", 255, 255, 255 )
		return false;
	end
	...
	isLocating = true
	waypointBlip = exports.customblips:createCustomBlip ( x, y, 20, 20, "files/waypointV2.png", 9999999999 )
	WAYPOINTLOC = { x=x, y=y }
