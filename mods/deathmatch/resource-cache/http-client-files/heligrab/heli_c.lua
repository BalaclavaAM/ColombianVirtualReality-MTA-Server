...
function updateGrabbingEffect()
	...
	if hangVehicle then
		if getElementInterior(localPlayer) ~= getElementData(localPlayer,"heligrab.interior") then triggerEvent("stopPlayerGrab", localPlayer, getElementData(localPlayer, "heligrab.vehicle"), true, "interior change") end
		if getElementDimension(localPlayer) ~= getElementData(localPlayer,"heligrab.dimension") then triggerEvent("stopPlayerGrab", localPlayer, getElementData(localPlayer, "heligrab.vehicle"), true, "dimension change") end
