...
function crearVentana3()
    ...
    GUIEditor.quitjob = guiCreateCheckBox(0.07, 0.13, 0.24, 0.08, "¿Quitar job?", true, true, GUIEditor.window[1])
    ...
    GUIEditor.players = guiCreateEdit(0.02, 0.74, 0.35, 0.07, "", true, GUIEditor.window[1])
    GUIEditor.label[3] = guiCreateLabel(0.03, 0.66, 0.44, 0.05, "Límite de jugadores (dejar vacío si no desea)", true, GUIEditor.window[1])    
    addEventHandler("onClientGUIClick", boton, enviarAlSv,false) 
    addEventHandler("onClientGUIClick", botonclose, togVentana3,false)
end
