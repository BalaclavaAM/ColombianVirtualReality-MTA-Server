...
-- LS 2
exports.ngwarpmanager:makeWarp ( { pos = { 2400.55, -1981.56, 14.55 }, toPos = { 286.15, -40.64, 1002.52 }, cInt = 0, cDim = 0, tInt = 1, tDim = 3 } )
exports.ngwarpmanager:makeWarp ( { pos = { 286.15, -40.64, 1002.52 }, toPos = { 2400.55, -1981.56, 14.55 }, cInt = 1, cDim = 3, tInt = 0, tDim = 0 } )
...
exports.ngwarpmanager:makeWarp ( { pos = { -2626.69, 208.25, 5.81}, toPos = { 286.15,-40.65,1001.52 }, cInt = 0, cDim = 0, tInt = 1, tDim = 2 } )
exports.ngwarpmanager:makeWarp ( { pos = { 285.3, -40.64, 1002.52 }, toPos = { -2626.69, 208.25, 5.81 }, cInt = 1, cDim = 2, tInt = 0, tDim = 0 } )
...
local items = {
	...
	{ "Pistolas", {
		{ "9mm", 22, 2500 },
		{ "Taser", 23, 4200 },
		{ "Desert Eagle", 24, 14400 }
	} },
	
	{ "SubAmetralladoras", {
		{ "Tec-9", 32, 3500 },
		{ "Micro SMF/Uzi", 28, 5500 }
	} },
	
	{ "Escopetas", {
		{ "Shotgun", 25, 2500 },
		{ "Recortadas", 26, 15000 },
		{ "Combat Shotgun", 27, 7500 },
	} },
	{ "Extra!", {
		{ "Paracaidas", 46, 75000 },
		{ "Cámara", 43, 250000 },
...
function dxDrawInterface( )
	...
	dxDrawRectangle ( sx - ( rSX * 300 ), sy / 2 - ( rSY * 150 ) /2 , rSX*280, rSY*200, tocolor(0, 0, 0, 200), false )
	dxDrawLinedRectangle ( sx - ( rSX * 300 ), sy / 2 - ( rSY * 150) /2, rSX*280, rSY*200, tocolor ( 0, 0, 0, 255 ), rSY*2, false )
	...
	dxDrawText ( "Usa las Flecas Arriba y Abajo para Navegar", sx - rSX*290,  sy / 2 - rSY*150 /2 + rSY*35, 0, 0, tocolor(255, 255, 255, 255), rSY*0.85, "default-bold", "left", "top", false, false, false, false, false)
	dxDrawText ( "Usa espacio para comprar", sx - rSX*290,  sy / 2 - rSY*150 /2 + rSY*55, 0, 0, tocolor(255, 255, 255, 255), rSY*0.85, "default-bold", "left", "top", false, false, false, false, false)
	dxDrawText ( "Usa la tecla el retroceso para salir/atrás", sx - rSX*290,  sy / 2 - rSY*150 /2 + rSY*75, 0, 0, tocolor(255, 255, 255, 255), rSY*0.85, "default-bold", "left", "top", false, false, false, false, false)
...
addEventHandler ( "onClientMarkerHit", marker, function ( p, md )
	if ( p == localPlayer  ) then
		setMenuOpen ( true )
	end
end ) addEventHandler ( "onClientMarkerLeave", marker, function ( p, md )
	if ( p == localPlayer  ) then
		setMenuOpen ( false )
	end
