...
local paths = { action = "logs/action", punish = "logs/punish", chat = "logs/chat", server="logs/server", sql="logs/sql", gang="logs/gang", vehicles="logs/vehicles" }
...
function outputGangLog ( chat, log )
	local path = paths.gang .. "/"..exports.NGPlayerFunctions:getToday ( )..".txt"
	if ( not fileExists ( path ) ) then
		local f = fileCreate ( path )
		fileWrite ( f, "This file was generated by Console at "..tostring ( getToday ( ) ).."\n\n\n" )
		fileFlush ( f )
...
function outputVehicleLog ( log )
	local path = paths.vehicles .. "/"..exports.NGPlayerFunctions:getToday ( )..".txt"
	if ( not fileExists ( path ) ) then
		local f = fileCreate ( path )
		fileWrite ( f, "This file was generated by Console at "..tostring ( getToday ( ) ).."\n\n\n" )
		fileFlush ( f )
	...
	if ( forwardLogsToConsole ) then print ( "[VEHICLE LOG] "..tostring( log ) ) end
end
