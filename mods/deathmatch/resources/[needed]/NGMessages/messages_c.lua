...
addEventHandler ( "onClientPlayerJoin", root, function ( ) 
	if joinquit then
		sendClientMessage ( "* "..getPlayerName(source).." se ha unido al servidor", 255, 150, 150 )
	end
end ) addEventHandler ( "onClientPlayerQuit", root, function ( r )
	if ( joinquit ) then
		sendClientMessage ( "* "..getPlayerName(source).." se ha desconectado del servidor ("..r..")", 255, 150, 150 )
	end
end )

-- Nickname changes
addEventHandler ( "onClientPlayerChangeNick", root, function ( o, n )
	sendClientMessage ( "* "..o.." es conocido como "..n, 255, 150, 150 )
end )