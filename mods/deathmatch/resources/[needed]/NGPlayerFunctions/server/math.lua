...
function createMathProblem ( p )
	...
	if not isMathQuestion then
		...
		outputChatBox ( "#DF743F[PREGUNTA MATEMÁTICA]#ffffff La primera persona en responder #ffff00"..question.."#ffffff ganará #00ff00$"..reward.."#ffffff (Usa /respuesta [RESPUESTA])", getRootElement ( ), 0, 0, 0, true ) 
...
addCommandHandler ( "respuesta", function ( p, cmd, answer )
