validVehicleModels = {
    ...
    mesa = 500, rcgoblin = 501, hotring2 = 502, hotrinb = 503, bloodra = 504, rnchlure = 505, supergt = 506, elegant = 507, journey = 508, chopperb = 509,
...
validPedModels = {
    male01=7, bfori = 9, bfost = 10, vbfycrp = 11, bfyri = 12, bfyst = 13, bmori = 14, bmost = 15, bmyap = 16, bmybu = 17, bmybe = 18,
    ...
    sbfystr = 256, swfystr = 257, heck1 = 258, heck2 = 259, bmycon = 260, wmycd1 = 261, bmocd = 262, vwfywa2 = 263, dwayne=268, wmoice = 264, laemt1 = 274,
    lvemt1 = 275, sfemt1 = 276, lafd1 = 277, lvfd1 = 278, sffd1 = 279, lapd1 = 280, sfpd1 = 281, lvpd1 = 282, csher = 283, lapdm1 = 284,
    swat = 285, fbi = 286, army = 297, dsher = 288, claude = 299, andre = 303, kendl = 304, zero = 306 , psycho=312, sweet = 270, fiorelli = 272
}