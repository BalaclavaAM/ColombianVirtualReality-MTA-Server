...
settings.stakeMax = 100000 -- maximum stake
...
settings.positionsMarkers = {
	{2255.1, 1618.79, 1006.18,0,1},
	{2255.1, 1614.89, 1006.18,0,1},
	{2255.1, 1610.84, 1006.18,0,1},
	
	{2272.58, 1606.69, 1006.18,0,1},
	{2268.53, 1606.69, 1006.18,0,1},
	
	{2218.6, 1619.8, 1006.18,0,1},
	{2218.51, 1615.47, 1006.18,0,1}
}
-- don't modify these unless you know what you are doing
settings.gamesPlayed = 1000  --anticheat - games played
...
local cards = {
	...
	-- bars
	{"slotMachineCards/goldbar.png", 10, 30},
	{"slotMachineCards/redbar.png", 5, 5},
	{"slotMachineCards/greenbar.png", 1, 3},
	-- luck related
	{"slotMachineCards/bell.png", 2, 5},
	{"slotMachineCards/heart.png", 2, 5},
	{"slotMachineCards/horseshoe.png", 2, 5},
	{"slotMachineCards/goldclover.png", 5, 15},
	{"slotMachineCards/greenclover.png", 2, 5},
	-- sevens
	{"slotMachineCards/goldenseven.png", 10, 30},
	{"slotMachineCards/redseven.png", 2, 15},
	-- gems
	{"slotMachineCards/ruby.png", 5, 15},
	{"slotMachineCards/emerald.png", 5, 15},
	{"slotMachineCards/diamond.png", 10, 30},
	-- vegetables and fruits
	{"slotMachineCards/cherry.png", 1, 2},
	{"slotMachineCards/grape.png", 1, 2},
	{"slotMachineCards/lemon.png", 1, 2},
	{"slotMachineCards/plum.png", 1, 2},
	{"slotMachineCards/watermelon.png", 1, 2},
}
...
localisation["spanish"] = {
	winenthiusastic = "Imposible, tres cartas al mismo tiempo, ganaste %d$!",
	win = "Doble hit, que suerte! Ganaste %d$",
	lose = "Sin suerte esta vez, triste :(",
	stakeMax = "No puedes apostar mas de %d$!",
	stakeMin = "No puedes jugar, a menos que apuestes %d$!",
	notEnoughCash = "No tienes el dinero suficiente para hacer una apuesta mayor!",
	notEnoughCashOnRoll = "No tienes suficiente dinero para lanzar!",
	stakeInfo = "Actual\nApuesta\n%d$",
	roll = "Jugar",
	leave = "Salir",
	whenRolling = "No puedes hacer eso mientras juegas!",
}
...
localisation["polish"] = {
	...
	notEnoughCashOnRoll = "Nie masz wystarczającej ilości gotówki aby zacząć losowanie!",
	stakeInfo = "Aktualna\nstawka\n%d$",
	roll = "Zagraj",
	leave = "Wyjdź",
...
local function showOnMarker()
	for k,v in ipairs(settings.positionsMarkers) do
		local marker = createMarker ( v[1], v[2], v[3]-1, "cylinder", 1.5, 255, 255, 0, 170 )
