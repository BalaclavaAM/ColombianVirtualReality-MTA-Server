...
addCommandHandler("turbo",addturbo)
...
function toggleEngines(bool)
	if bool then
		outputChatBox("Sonidos realistas activados",255,0,0)
	else
		outputChatBox("Sonidos realistas desactivados",255,255,0)
	end
	ENGINE_ENABLED = bool
...
addEvent("bengines:toggleEngines",true)
addEventHandler("bengines:toggleEngines",root,toggleEngines)
...
addEventHandler("onClientResourceStart", resourceRoot, function()
	toggleEngines(exports.NGPhone:getSetting ( "usersetting_misc_enablemotors" ))
end)
