...
function bindTrainHorn(thePlayer, seat, jacked)
    if thePlayer and getElementType(thePlayer) == "player" and (getElementModel(source) == 437 or
...
function toggleTrainHorn(thePlayer, cmd)
	...
	if train and (getElementModel(train) == 437 or getElementModel(train) == 538 or
